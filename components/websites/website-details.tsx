    ...
    <div className="container mx-auto p-4 md:p-6 max-w-7xl">
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row gap-4">
          {/* Note: These buttons are now redundant as sidebar handles navigation */}
          {/* Keeping them for visual consistency with your previous request, but they can be removed */}
                            ...
                            <div className="flex items-start space-x-2">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-emerald-800 leading-relaxed">
                                  Your subscription will be instantly canceled, and you won't be able to access your chats anymore
                                </p>
                              </div>
                            </div>
                          </div>
