        ...
        const config = {
          ...
          translatedPhrases: {
            ...
            'Click "Start New Conversation" to begin!':
              'Натисніть "Почати нову розмову", щоб почати!',
            "Created:": "Створено:",
            ...
            "Please choose an option to continue.":
              "Будь ласка, виберіть варіант, щоб продовжити.",
            ...
            "Error processing your message.":
              "Помилка обробки вашого повідомлення.",
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg rounded-3xl relative overflow-hidden h-full max-h-[calc(100vh-2rem)] overflow-y-auto">
          ...
          <CardContent className="space-y-8 relative z-10">
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="flex items-center space-x-2 font-semibold">
                    <Users className="w-4 h-4 text-teal-500" /> Staff Initials
                    Display
                  </span>
                  <ChevronDown
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Label className="text-slate-700 font-semibold text-sm flex items-center">
                  <Zap className="w-4 h-4 mr-2 text-yellow-500" /> Remove
                  "Powered by" Branding
                </Label>
                <div className="flex items-center justify-between p-4 bg-slate-50/80 border border-slate-200/60 rounded-2xl">
                  <span
                    className={`text-slate-900 font-medium ${
                      !isProOrEnterprise ? "opacity-50" : ""
                    }`}
                  >
